...
public class SerializeBenchmark
{
    ...
    [Benchmark]
    public async ValueTask<TestSerial> DeserializeAsync()
    {
        using var memoryStream = new MemoryStream(_testSerialBytes);
        return await KeyValueSerializer.DeserializeAsync<TestSerial>(memoryStream, _configuration, _cancellationToken);
    }
    ...
    public void Serialize()
    {
        ...
        KeyValueSerializer.Serialize(_testSerial, memoryStream);
    }
